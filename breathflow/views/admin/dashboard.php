...
<body class="page-bg min-h-screen text-white antialiased flex flex-col">
    ...
    <main class="flex-1 px-6 lg:px-16 pt-32 pb-16 max-w-7xl mx-auto w-full space-y-12">
        ...
        ═══════════════════════════════════════════════════════ -->
        <div class="glass-panel rounded-3xl p-8 lg:p-10 fade-in-up" style="animation-delay: 0.2s;">
            <h2 class="text-xl font-bold text-white mb-8 flex items-center gap-3 border-b border-white/10 pb-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <!-- Product CRUD shortcut -->
                <a href="index.php?page=admin/products"
                   class="group flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-teal-500/40 hover:bg-teal-500/5 transition-all">
                    <div class="w-10 h-10 rounded-xl bg-teal-500/15 flex items-center justify-center shrink-0 group-hover:bg-teal-500/25 transition-colors">
                        <svg class="w-5 h-5 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10"/>
                        </svg>
                    </div>
                    <div>
                        <p class="font-bold text-white text-sm">Manage Products</p>
                        <p class="text-xs text-gray-400">Add, edit &amp; remove cartridges</p>
                    </div>
                </a>

                <!-- Add Product shortcut -->
                <a href="index.php?page=admin/products/create"
                   class="group flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-teal-500/40 hover:bg-teal-500/5 transition-all">
                    <div class="w-10 h-10 rounded-xl bg-teal-500/15 flex items-center justify-center shrink-0 group-hover:bg-teal-500/25 transition-colors">
                        <svg class="w-5 h-5 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        <p class="font-bold text-white text-sm">Add New Product</p>
                        <p class="text-xs text-gray-400">Create a new cartridge listing</p>
                    </div>
                </a>

                <!-- Subscriptions shortcut -->
                <?php if ($adminRole === 'admin'): ?>
                <a href="index.php?page=admin/subscriptions"
                   class="group flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-indigo-500/40 hover:bg-indigo-500/5 transition-all">
                    <div class="w-10 h-10 rounded-xl bg-indigo-500/15 flex items-center justify-center shrink-0 group-hover:bg-indigo-500/25 transition-colors">
                        <svg class="w-5 h-5 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                    </div>
                    <div>
                        <p class="font-bold text-white text-sm">Manage Subscriptions</p>
                        <p class="text-xs text-gray-400">View &amp; update Core Club members</p>
                    </div>
                </a>
                <?php endif; ?>
